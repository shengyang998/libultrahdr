...
| `UHDR_MAX_DIMENSION` | 11656 | Maximum dimension supported by the library. The library defaults to handling images upto resolution 11656x11656. For different resolution needs use this option. For example, `-DUHDR_MAX_DIMENSION=4096`. |
